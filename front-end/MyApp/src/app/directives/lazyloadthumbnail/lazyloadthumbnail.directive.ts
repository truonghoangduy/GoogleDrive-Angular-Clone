...
export class LazyloadthumbnailDirective {
  ...
  protected ngOnChanges() {
    ...
    this.getThumbNail(this.fileLocation).then(newURL=>this.elm.nativeElement.src = newURL)
  ...
  getThumbNail(path:string):Promise<string>{
    return this.thumbnailServices.getThumbnail(path).then((pictureBuffer) => {
      ...
      // = "https://images.foody.vn/res/g88/876281/s800/foody-ga-chien-chicken-plus-740-637148089657120363.jpg";
